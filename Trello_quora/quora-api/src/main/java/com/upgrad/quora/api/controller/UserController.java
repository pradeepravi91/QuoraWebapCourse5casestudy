...
public class UserController {
    ...
    /*This endpoint is a POST request and is used to register a new user i.e. userSignup in the Quora Application.
     and Throws SignUpRestrictedException if email Id provided by the user already exists*/
    ...
    /*This endpoint is a POST method used for user authentication,
    throws an AuthenticationFailedException, if the username provided by the user does not exist*/
